...
namespace testeArcEasyObjects.Cartografia.Model
{
    ...
    public class SolicitacaoIntervencaoOP : ArcEasyObjects.BaseModel, IComparable<SolicitacaoIntervencaoOP>
    {
        ...
        [EntityField("NU_OCORRENCIA_OP_ID", typeof(int))]
        ...
        [EntityField("NU_BAIRRO_ID", typeof(int))]
        ...
        [EntityField("NU_USUARIO", typeof(int))]
        ...
        [EntityKeyField("NU_SOLIC_INTERVENCAO_OP_ID", typeof(int), "NEOSDE.SEQ_SI_OP")]
        ...
        [EntityField("NU_REGIONAL_ID", typeof(int))]
        ...
        [EntityField("CD_CODIGO_AREA", typeof(int))]
        ...
        [EntityField("NU_TIPO_NATUREZA_OP_ID", typeof(int))]
        ...
        [EntityField("NU_TIPO_SOLIC_INTERV_OP_ID", typeof(int))]
        ...
        [EntityField("NU_MOTIVO_SOLIC_INTERV_OP_ID", typeof(int))]
        ...
        [EntityField("NU_EMPRESA_ID", typeof(int))]
        ...
        [EntityField("CD_TIPO_DESLIGAM_SOLIC_INTERV", typeof(int))]
        ...
        [EntityField("CD_STATUS_SOLIC_INTERVENCAO", typeof(int))]
        ...
        [EntityField("CD_CANCELAMENTO_SOLIC_INTERV", typeof(int))]
        ...
        [EntityField("NU_INSTALACAO_MT_ID", typeof(int))]
        ...
        [EntityField("NU_EMPREITEIRA_ID", typeof(int))]
        ...
        [EntityField("CD_CARACTERISTICA", typeof(int))]
        ...
        [EntityField("CD_SI_PRINCIPAL", typeof(int))]
        ...
        [EntityField("NU_OBJECTID_SUBESTACAO", typeof(int))]
        ...
        [EntityField("NU_USU_ID_SUBSTITUTO", typeof(int))]
        ...
        [EntityField("NU_USU_ID_SUBSTITUTO2", typeof(int))]
        ...
        [EntityField("NU_USU_ID_SUBSTITUTO3", typeof(int))]
        ...
        [EntityField("NU_USU_ID_TECNICO", typeof(int))]
        ...
        [EntityField("NU_USU_ID_RESPONSAVEL", typeof(int))]
        ...
        [EntityField("CD_AREA_RESPONSAVEL", typeof(int))]
        ...
        [EntityField("CD_ORGAO_EXECUTOR", typeof(int))]
        ...
        [EntityField("NU_CONTRATO_CONS_ID", typeof(int))]
        ...
        public DateTime dt_inicio
        {
            get
            {
                if (Dt_inicio_real != null)
                    return Dt_inicio_real;
                return Dt_inicio_previsto;
            }
        }
        ...
        public DateTime dt_final
        {
            get
            {
                if (Cd_status_solic_intervencao == 6)
                    return Dt_termino_real;
                return Dt_termino_previsto;
            }
        }
